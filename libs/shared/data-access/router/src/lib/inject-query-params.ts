 ...
 */
export type QueryParamsOptions<ReadT, WriteT, InitialValueT> = {
  /**
 ...
 */
export function injectQueryParams<ReadT = Params>(): Signal<ReadT>;
...
export function injectQueryParams<ReadT>(
  ...
  return toSignal(route.queryParams.pipe(map(getParams)), {
    initialValue: getParams(queryParams),
  });
}
